...
{
    public class ContestsBasicController : Controller
    {
        private BillBakalimContext db = new BillBakalimContext();
        Repository<ContestType> repoConType = new Repository<ContestType>(new BillBakalimContext());

        // GET: Admin/ContestsBasic
        public ActionResult Index()
        {
            return View(db.Contests.ToList());
        }

        // GET: Admin/ContestsBasic/Details/5
        ...
        // GET: Admin/ContestsBasic/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/ContestsBasic/Create
        ...
        // GET: Admin/ContestsBasic/Edit/5
        ...
        // POST: Admin/ContestsBasic/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/ContestsBasic/Delete/5
        ...
        // POST: Admin/ContestsBasic/Delete/5
